...
VALUES
(uuid_generate_v4(), 'prod-web-01', '10.0.1.11', 'PRODUCTION', 'AWS', 'us-east-1', 't3.medium', 'HEALTHY', 'demo-api-key-12345'),
(uuid_generate_v4(), 'prod-web-02', '10.0.1.12', 'PRODUCTION', 'AWS', 'us-east-1', 't3.medium', 'WARNING', 'demo-api-key-12345'),
(uuid_generate_v4(), 'prod-db-01', '10.0.2.10', 'PRODUCTION', 'AWS', 'us-east-1', 'db.r5.large', 'HEALTHY', 'demo-api-key-12345'),
(uuid_generate_v4(), 'staging-api-01','10.0.5.20', 'STAGING', 'Azure', 'eastus', 'Standard_B2s', 'CRITICAL', 'demo-api-key-12345')
ON CONFLICT DO NOTHING;
