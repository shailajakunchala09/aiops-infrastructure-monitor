    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-base-900 relative overflow-hidden">
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-1">
          ...
          <div className="font-mono text-[15px] font-bold tracking-wide text-slate-50">
            AIOPS CONSOLE
          </div>
        </div>

        <p className="text-[13px] text-slate-500 mt-2 mb-7">
          Sign in to view infrastructure health, incidents,
          and alerts.
        </p>
        ...
        <label
          htmlFor="email"
          className="block text-[12px] font-medium text-slate-400 mb-1.5"
        >
          Email
        </label>
        ...
        {error && (
          <motion.div
            ...
            className="flex items-start gap-1.5 text-signal-critical text-[12.5px] mt-3"
          >
            <AlertCircle
              size={13}
