...
const api = axios.create({
  baseURL: "https://aiops-infrastructure-monitor.onrender.com/api/v1",
});
...
export const metricApi = {
  getForServer: (serverId, hours = 24) =>
    api.get(`/metrics/servers/${serverId}`, {
      params: { hours },
    }),

  getSummary: (serverId, hours = 24) =>
    api.get(`/metrics/servers/${serverId}/summary`, {
      params: { hours },
    }),
};
...
export const logApi = {
  ...
  levelDistribution: (hours = 24) =>
    api.get("/logs/analytics/level-distribution", {
      params: { hours },
    }),

  topErrors: (hours = 24) =>
    api.get("/logs/analytics/top-errors", {
      params: { hours },
    }),
};
...
export const incidentApi = {
  ...
  monthlyTrends: (months = 6) =>
    api.get("/incidents/trends/monthly", {
      params: { months },
    }),
